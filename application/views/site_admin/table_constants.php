<?php
	...
	if (!defined('RESOURCES'))						define('RESOURCES', 15);
	...
	if (!defined('SHOW_ALL_ADMIN_COURSES'))    		define('SHOW_ALL_ADMIN_COURSES', 12);
	if (!defined('SHOW_LECTURE_ADMIN_SCHEDULE'))	define('SHOW_LECTURE_ADMIN_SCHEDULE', 13);
	if (!defined('SHOW_ALL_RESOURCES'))				define('SHOW_ALL_RESOURCES', 14);
	...
	if (!defined('TITLE_FIELD')) 		define('TITLE_FIELD', 2);
	if (!defined('DESC_FIELD')) 		define('DESC_FIELD', 4);
	if (!defined('DATE_FIELD')) 		define('DATE_FIELD', 8);