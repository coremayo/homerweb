				 ...
				 <tbody>
					<?php 	
						foreach ($result as $classInfo)
						{
							...
							{
								echo	'<tr>      
										<td><a href="homerweb/main/courses/moreInfo.php">'.$classInfo->classTitle.'</a></td>
				 ...
				 <tbody>
					<?php 	
						foreach ($result as $classInfo)
						{
							...
							{
								echo	'<tr>      
										<td><a href="homerweb/main/courses/moreInfo.php" onclick="window.open("homerweb/main/courses/moreInfo.php","popup","width=500,height=500,scrollbars=no,resizable=no,toolbar=no,directories=no,location=no,menubar=no,status=no,left=0,top=0"); return false">'.$classInfo->classTitle.'</a></td>
										<td>'.$classInfo->classDesc.'</td>
										<td>'.$classInfo->classStartDate.'</td>
										<td>'.$classInfo->classEndDate.'</td>
										<td>'.$classInfo->classPrice.'</td>
