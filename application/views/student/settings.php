					...
					<table class="text" border="0" cellpadding="4" cellspacing="3" width="100%">
                        ...
                        <tr>
                         ...
                         <tr>
							...
							<td width ="75%"><input type="text" name="pass" size="35" maxlength"50" class="input" value=""></td>
						</tr>
                         <tr>
							<td align="right" bgcolor="#addbf0" width="25%">Confirm Password:</td>
							<td width ="75%"><input type="text" name="repass" size="35" maxlength"50" class="input" value=""></td>
						</tr>
                        <tr>
